...
if ($row['radminsuper'] == 1) {
    ...
    function BannersAdd($name, $cid, $adname, $imptotal, $imageurl, $clickurl, $alttext, $position, $active, $ad_class, $ad_code, $ad_width, $ad_height)
    {
        ...
        if (($ad_class == 'image' or $ad_class == 'flash') and ($ad_width == '' or $ad_height == '')) {
            $a = 1;
        }
        if (($ad_class == 'image') and ($imageurl == 'http://' or $imageurl == '')) {
            $a = 1;
        }
        if (($ad_class == 'image' or $ad_class == 'flash') and ((!is_numeric($ad_width) || !is_numeric($ad_height)))) {
            $a = 1;
        }
