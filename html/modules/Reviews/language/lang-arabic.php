...
define('_RCREATEACCOUNT', '<a href=modules.php?name=Your_Account>اشتراك </a> جديد');
...
define('_PAGE', 'صفحة');
define('_PAGEBREAK', 'اذا أردت صفحات متعددة فإنك تستطيع أن تكتب  <b>[--pagebreak--]</b> في مكان القص.');
