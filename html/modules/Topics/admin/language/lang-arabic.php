...
define('_YES', 'نعم');
define('_NO', 'لا');
define('_TOPICSMANAGER', 'ادارة المواضيع');
define('_DELETETOPIC', 'حذف الموضوع');
define('_TOPICDELSURE', 'هل تريد حذف الموضوع بالتأكيد؟');
define('_TOPICDELSURE1', 'هذا سيحذف جميع المقالات والتعليقات في هذا الموضوع!');
