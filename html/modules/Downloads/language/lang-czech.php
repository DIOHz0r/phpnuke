...
define("_URL","URL");
define("_PREVIOUS","Předchozí stránka");
...
define("_ADDDOWNLOAD","Přidat ke staení");
define("_DOWNLOADSMAIN","Hlavní kategorie");
define("_DOWNLOADCOMMENTS","Komentáře");
define("_DOWNLOADSMAINCAT","Hlavní kategorie");
define("_ADDADOWNLOAD","Přidat soubor ke staení");
define("_DSUBMITONCE","Polete soubor pouze jednou.");
define("_DPOSTPENDING","Vechny poslané soubory musí být ověřeny.");
define("_RESSORTED","Soubory jsou momentálně řazeny");
define("_DOWNLOADSNOTUSER1","Nejste registrovaný uivatel nebo nejste přihláen(a).");
define("_DOWNLOADSNOTUSER2","Pokud se zaregistrujete, můete přidávat soubory ke staení na tomto webu.");
define("_DOWNLOADSNOTUSER3","Stát se registrovaným uivatelem je snadný a rychlý proces..");
define("_DOWNLOADSNOTUSER4","Proč vyadujeme registraci?");
define("_DOWNLOADSNOTUSER5","Chceme vám poskytnou sluby nejvyí kvality,");
define("_DOWNLOADSNOTUSER6","kadá poloka je samostaně zkontrolována a odsouhlasena naimi spolupracovníky.");
define("_DOWNLOADSNOTUSER7","Doufáme, e vám budeme poskytovat pouze hodnotné informace.");
define("_DOWNLOADSNOTUSER8","<a href=\"modules.php?name=Your_Account\">Zaloit účet</a>");
...
define("_DOWNLOADRECEIVED","Přijali jsme vá odkaz ke zpracování. Díky!");
...
define("_DDATE1","data (nejdříve starí)");
define("_DDATE2","data (nejdříve novějí)");
...
define("_DLETSDECIDE","Hlasováním pomáháte ostatním uivatelům při rozhodování který soubor stáhnout.");
define("_DATE","Datum");
define("_TO","Komu");
define("_NEW","Nové");
