...
define('_EDITTHISDOWNLOAD', 'Bu Dosyayı Düzenle');
define('_DOWNLOADRATING', 'Dosya Puanları');
define('_DOWNLOADVOTE', 'Oy Ver!');
define('_DONLYREGUSERSMODIFY', 'Sadece kayıtlı kullanıcılar dosya değişikliği önerebilirler. Lütfen <a href="modules.php?name=Your_Account">kayıt olun yada sisteme giriş yapın</a>.');
...
define('_DRATENOTE4', '<a href="downloads.php?op=TopRated">En İyi Kaynaklar</a> listesini görebilirsiniz.');
define('_DATE', 'Tarih');
define('_TO', 'Kime');
define('_NEW', 'Yeni');
