...
define("_DOWNLOADSNOTUSER1","Vi niste registriran član ali pa se niste prijavili.");
define("_DOWNLOADSNOTUSER2","Če bi bili registrirani bi lahko dodajali downloade na to strani.");
define("_DOWNLOADSNOTUSER3","Registriranje je hiter in enostaven proces.");
define("_DOWNLOADSNOTUSER4","Zakaj zahtevamo registracijo za pristop določenim stvarem?");
...
define("_DLETSDECIDE","Komentarji uporabnikov kot ste Vi bodo pomagali drugim da se laje odločijo na kateri download naj kliknejo.");
...
define("_SECURITYBROKEN","Iz sigurnostnih razlogov je Vae uporabniko ime in IP naslov začasno zabeleen.");
