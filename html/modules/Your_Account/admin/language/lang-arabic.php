...
define('_YEAR', 'السنة');
define('_USERADMIN', 'التحكم في الأعضاء');
define('_EDITUSER', 'تعديل عضو');
define('_MODIFY', 'تعديل');
define('_ADDUSER', 'اضافة عضو جديد');
define('_FAKEEMAIL', 'البريد الإلكتروني غير الحقيقي');
define('_ALLOWUSERS', 'تمكين الأخرين من رؤية بريدي');
define('_ADDUSERBUT', 'أضف عضو');
define('_USERUPDATE', 'تحديث ملف العضو');
define('_USERID', 'رقم العضو');
define('_USERNOEXIST', 'هذا العضو غير موجود!');
define('_PASSWDNOMATCH', 'عفوا كلمة السر الجديدة غير متطابقة. اضغط زر العودة وحاول مرة اخرى');
define('_DELETEUSER', 'حذف عضو');
define('_SURE2DELETE', 'هل تريد حذف العضو بالتأكيد؟');
define('_NEEDTOCOMPLETE', 'تحتاج الى إكمال جميع الجقول');
