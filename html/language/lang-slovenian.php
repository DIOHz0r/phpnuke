...
define('_PASTARTICLES', 'Prejnji članki');
...
define('_ASREGISTERED', 'Nimate računa? Lahko ga <a href="modules.php?name=Your_Account">odprete brezplačno</a>. Kot');
define('_MENUFOR', 'Kazalo za');
define('_NOBIGSTORY', 'Danes ni bilo novih člankov.');
define('_BIGSTORY', 'Dananji najbolj brani članek je:');
...
define('_YOUAREANON', 'Vi ste neregistrirani obiskovalec. Lahko se registrirate brezplačno <a href="modules.php?name=Your_Account">tukaj</a>');
...
define('_MVIEWUSERS', 'Vide: samo člani');
