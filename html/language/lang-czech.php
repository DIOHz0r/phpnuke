...
define("_OLDERARTICLES","Starí články");
define("_BY","podle");
define("_ON","v");
...
define("_ASREGISTERED","Jetě nemáte svůj účet? Můete si jej <a href=\"modules.php?name=Your_Account\">vytvořit zde</a>. Jako registrovaný uivatel získáte řadu výhod. Například posílání komentářu pod jménem, nastavení komentářů, manaer témat atd.");
define("_MENUFOR","Menu pro");
define("_NOBIGSTORY","Dosud není článek dne.");
define("_BIGSTORY","Nejčtenějí článek dnes je:");
...
define("_GUESTS","návtěvník(ů) a");
define("_MEMBERS","uivatel(ů) online.");
define("_YOUARELOGGED","Jste přihláen jako");
define("_YOUHAVE","Máte");
define("_PRIVATEMSG","osobních zpráv.");
define("_YOUAREANON","Jste anonymní uivatel. Můete se zdarma registrovat kliknutím <a href=\"modules.php?name=Your_Account\">zde</a>");
...
define("_MVIEWUSERS","Zobrazit: Pouze přihláeným uivatelům");
define("_MVIEWANON","Zobrazit: Pouze anonymům");
define("_MVIEWALL","Zobrazit: Vem návtěvníkům");
define("_EXPIRELESSHOUR","Konec zobrazování: méně ne 1 hodina");
define("_EXPIREIN","Konec zobrazování za");
define("_HTTPREFERERS","Odkud přili");
