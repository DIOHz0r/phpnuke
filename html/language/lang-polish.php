...
define('_ASREGISTERED', 'Nie masz jeszcze konta? Możesz <a href="modules.php?name=Your_Account&amp;op=new_user">sobie założyć</a>. Jako zarejestrowany użytkownik będziesz miał kilka przywilejów.');
...
define('_YOUAREANON', 'Jesteś anonimowym użytkownikiem. Możesz się zarejestrować za darmo klikając <a href="modules.php?name=Your_Account&amp;op=new_user">tutaj</a>');
...
define('_MODULEUSERS', 'Sorry, ale ta część naszej strony jest <i>wyłącznie dla zarejestrowanych użytkowników</i><br><br>Możesz zarejestrować się bezpłatnie klikając <a href="modules.php?name=Your_Account&op=new_user">tutaj</a>, wtedy będziesz miał<br>dostęp do tego modułu bez ograniczeń.<br><br>');
...
define('_THISISAUTOMATED', 'Jest to automatyczne powiadomienie o zakończeniu wyświetlania bannera na naszej stronie.');
 define('_THERESULTS', 'Rezultaty kampanii przedstawiają się następująco:');
define('_TOTALIMPRESSIONS', 'Odsłon:');
define('_CLICKSRECEIVED', 'Kliknięć:');
define('_IMAGEURL', 'URL bannera:');
define('_CLICKURL', 'URL docelowy:');
define('_ALTERNATETEXT', 'Tekst zastępczy:');
define('_HOPEYOULIKED', 'Mamy nadzieję, że polubiłeś nasz serwis. Liczymy na kontynuację naszej współpracy.');
define('_THANKSUPPORT', 'Dziękujemy za wsparcie');
define('_TEAM', 'Zespół');
define('_BANNERSFINNISHED', 'Zakończone bannery');
